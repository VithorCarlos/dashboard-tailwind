  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton:
          'text-error-700 hover:text-error-90 dark:text-error-400 dark:hover:text-error-300',
      },
    },
  },
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm font-medium text-error-600 dark:text-zinc-100">
              {name}
            </span>
          </div>

          <button className="text-sm font-semibold text-error-700 hover:text-error-900 dark:text-error-500 dark:hover:text-error-300">
            Try again
          </button>
        </div>
      ) : (
